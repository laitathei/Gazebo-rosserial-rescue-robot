...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        ...
        left_wheel_diff = float(current_left*1.75-saved_left*1.75)
        right_wheel_diff = float(current_right*1.75-saved_right*1.75)
        ...
        moved_distance =  (0.0-((right_wheel_moved+left_wheel_moved)/2.0))
