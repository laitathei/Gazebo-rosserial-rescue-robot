...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        ...
        # pose
        data_odom.pose.position.x = current_x_position                  # change
        data_odom.pose.position.y = current_y_position                # change
        data_odom.pose.position.z = 0.0               # unchange

        # orientation
        data_odom.pose.orientation.x = 0.0               # unchange
        data_odom.pose.orientation.y = 0.0               # unchange
        data_odom.pose.orientation.z = moved_radian            # change
