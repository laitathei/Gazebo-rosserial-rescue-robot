...
if __name__ == "__main__":
    ...
    while check == False:
        ...
        if choice == 2:
            ...
            data_odom2.pose.position.y = 0.0     # change
        ...
        if choice == 3:
            ...
            # pose
            data_odom3.pose.position.x = 0.0                  # unchange
            data_odom3.pose.position.y = 0.0     # change
        ...
        if choice == 4:
            ...
            # pose
            data_odom4.pose.position.x = 0.0                  # unchange
            data_odom4.pose.position.y = 0.0     # change
        ...
        if choice == 5:
            ...
            # pose
            data_odom5.pose.position.x = 0.0                  # unchange
        ...
        if choice == 6:
            ...
            # pose
            data_odom6.pose.position.x = 0.0                  # unchange
            data_odom6.pose.position.y = 0.0     # change
        ...
        if choice == 8:
            ...
            # pose
            data_odom8.pose.position.x = 0.0                  # unchange
            data_odom8.pose.position.y = 0.0     # change
